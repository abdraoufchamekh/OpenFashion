...
class _PlaceOrderState extends State<PlaceOrder> {
  ...
  void _openAddress(context) async {
    final addressData = await Navigator.push(
      context,
      MaterialPageRoute(builder: (c) => const AddAddress(
      )),
    );
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              _savedCard != null && _savedAddress != null ? const SizedBox.shrink() : CustomText(
              ...
              /// Shipping Method
              _savedCard != null && _savedAddress != null ? const SizedBox.shrink() : const ShippingMethod(),
              ...
              Row(
                ...
                children: [
                  const CustomText(text: "Total", color: AppColors.primary),
                  CustomText(
